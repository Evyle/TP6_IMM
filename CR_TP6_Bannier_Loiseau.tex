...
\begin{figure}[h]
	\centering
		%TODO Mettre le chemin vers l'image \includegraphics[width=250px]{./images/screen1.png}
...
%Mettre le code ici
\end{verbatim}
%TODO Commenter le code si n\'ecessaire
...
%TODO
\begin{center}
    \makebox[\textwidth]{\includegraphics[width=1.0\textwidth]{./images/q8.png}}
\end{center}
...
%TODO
% \begin{center}\makebox[\textwidth]{\includegraphics[width=1.0\textwidth]{./images/q11_0.4.png}}\end{center}
