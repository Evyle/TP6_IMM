...
int main()
{
    ...
    double trans = 0.002;
    world_poseProbe[0] += trans;
    world_poseProbe[1] += trans;
    world_poseProbe[2] += trans;

    world_poseProbe[3] += vpMath::rad(2);
    world_poseProbe[4] += vpMath::rad(2);
    world_poseProbe[5] += vpMath::rad(4);
    ...
    try  {
        while(1)
        {
            ...
            // All sinusoidal signals should have a period of 5 seconds. The current time is given by
